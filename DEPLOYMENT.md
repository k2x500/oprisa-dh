...
You need to allow external web traffic to access port `8000` where the dashboard is served.
...
4. Configure it with:
   ...
   - **Protocols and ports**: Under **Specified protocols and ports**, check **TCP** and enter `8000`.
5. Click **Create**.
